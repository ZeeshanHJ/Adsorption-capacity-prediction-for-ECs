"""
This file shows application of Gradient Boosting model to predict 'ECs adsorption capacity on Biochar materials'
"""
...
gb_run = ensemble.GradientBoostingRegressor(random_state=0)
gb_run.get_params()
...
gb_BO = BayesianOptimization(bo_params_gb, {'max_depth': (60,100),
                                            'min_samples_leaf': (1,4),
                                            'min_samples_split': (2,10),
                                            'n_estimators': (100, 250),
                                            'learning_rate': (0.001, 1.0)},
                              random_state=1)
results = gb_BO.maximize(n_iter=200, init_points=20,acq='ei')
...
## 06. Model evaluation
    # train
train_predict = gb_run.predict(X_train)
print("The training RMSE of the Gradient boosting model is :\t", np.sqrt(mean_squared_error(train_predict,y_train)))
print("The training R^2 of the Gradient boosting model is :\t", r2_score(train_predict,y_train))
print("The training MAE of the Gradient boosting model is :\t", mean_absolute_error(train_predict,y_train))
    # validation
test_predict = gb_run.predict(X_test)
print("The test RMSE of the Gradient boosting model is :\t",  np.sqrt(mean_squared_error(test_predict,y_test)))
print("The test R^2 of the Gradient boosting model is :\t",  r2_score(test_predict,y_test))
print("The test MAE of the Gradient boosting model is :\t",  mean_absolute_error(test_predict,y_test))
